<template>
  <div class="table">
      ...
      <el-form ref="queryForm" :inline="true" :model="queryForm" label-width="80px" size="mini">
        ...
        <div v-show="isShowMore">
          ...
          <el-form-item prop="contactStatus">
            <el-select v-model="queryForm.contactStatus" clearable placeholder="跟进状态" class="handle-select mr10">
          ...
          <el-form-item label="意向活动" label-width="120px" prop="intentionLevel">
    ...
    <div v-if="checkedData.length>0" style="margin:5px;">
      <el-button type="primary" icon="el-icon-edit" size="mini" @click="dialogFormVisible=true">批量分配</el-button>
    </div>
    <el-table :data="tableData" stripe v-loading="loading" @sort-change="handSortChange" border style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="负责人" sortable="custom" prop="ownerId">
      </el-table-column>
      <el-table-column label="来源活动" sortable="custom" prop="sourceId">
      </el-table-column>
      <el-table-column label="沟通次数" sortable="custom" prop="contactNumber">
        <template slot-scope="scope">
          <a href="javascript:void(0)" @click="handleContact(scope.row)">{{scope.row.contactNumber}}</a>
        </template>
      </el-table-column>
      ...
      <el-table-column label="跟进状态" sortable="custom" prop="contactStatus" :formatter="filterContactStatus">
      </el-table-column>
        ...
        <template slot-scope="scope">
          <el-dropdown split-button type="primary" @click="handleEdit(scope.$index, scope.row)" @command="hadleCommand" size="small">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item :command="{row:scope.row,type:'invite'}">邀约</el-dropdown-item>
              <el-dropdown-item v-if="scope.row.theType!=9" :command="{row:scope.row,type:'delete'}">删除</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
      </el-table-column>
