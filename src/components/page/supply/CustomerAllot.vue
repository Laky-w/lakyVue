<template>
  <div class="table">
    ...
    <el-table :data="tableData" stripe v-loading="loading" border style="width: 100%" @selection-change="handleSelectionChange">
    ...
    <contact-form :student-id="studentId" @save-success="getData()" :dialog-form-visible.sync="dialogContactVisible"></contact-form>
...
export default {
  ...
  components: { CustomerForm, CustomerView, ContactForm, SchoolTree } //注入组件
};
</script>
