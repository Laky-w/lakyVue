  ...
  <div class="table">
    <div class="handle-box">
        <el-form ref="queryForm" :inline="true" :model="queryForm" label-width="80px" size="mini">
            ...
            <el-form-item >
              <el-select v-model="queryForm.sex" value=1 clearable placeholder="性别"
    ...
    <el-dialog title="添加正式学员" :visible.sync="dialogFormVisible" width="750px" custom-class="dialog-form"
        ...
        <el-form :model="form" ref="ruleForm" inline size="small">
            ...
            <el-form-item label="学管师" :label-width="formLabelWidth" prop="ownerId">
                <user-dialog v-model="form.ownerId" title="学管师"
                              :the-type="3" :parent-school-id="form.schoolZoneId"
                              placeholder-text="学管师"></user-dialog>
            </el-form-item>
