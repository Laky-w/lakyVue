      ...
      <el-form ref="queryForm" :inline="true" :model="queryForm" label-width="80px" size="mini">
        ...
        <el-form-item>
          <el-select v-model="queryForm.costStatus" clearable placeholder="缴费状态" class="handle-select mr10">
            <el-option key="1" label="已退齐" value="1"></el-option>
            <el-option key="2" label="未退齐" value="2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
      ...
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand" :loading="loadingAccount">
            <el-form-item v-for="(item,index) in props.row.detailList" :key="index" class="detail-content">
