    ...
    <div class="table">
        <div class="handle-box">
            <el-form ref="queryForm" :inline="true" :model="queryForm" label-width="80px" size="mini">
                <el-form-item>
                    <el-input v-model="queryForm.name" clearable placeholder="账户名称"
                ...
                <el-form-item>
                    <el-select v-model="queryForm.theType" value=1 clearable placeholder="账户类型"
        ...
        <el-dialog title="添加账户" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
            <el-form :model="form" ref="ruleForm">
                ...
                <el-form-item label="类型" style="display: inline-block;" :label-width="formLabelWidth" prop="theType"
                ...
                <el-form-item label="校区" :label-width="formLabelWidth" prop="schoolName"
                    ...
                    <school-tree @nodeClick="handleSchool" :name="form.schoolName" :the-type="2"
                                 :disabled="form.isPublic" place-text="校区" :default-value="schoolId"></school-tree>
                </el-form-item>
