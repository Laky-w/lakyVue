    ...
    <el-dialog title="添加退货" :visible.sync="dialogFormVisible" width="750px">
      <el-form :model="form" ref="ruleForm">
        <el-form-item label="退货日期" prop="createTime" :label-width="formLabelWidth" style="display:inline-block;" :rules="[{required:true,message:'退货日期必填'}]">
          <el-date-picker type="date" v-model="form.createTime" format="yyyy-MM-dd" placeholder="退货日期">
          </el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="退货信息" required :label-width="formLabelWidth" size="mini" style="margin-bottom:0px;">
