<template>
  <div class="table">
    ...
    <el-table :data="tableData" stripe v-loading="loading" border show-summary @sort-change="handSortChange" style="width: 100%">
      ...
      <el-table-column label="进货数量" sortable="custom" prop="amount">
      </el-table-column>
      </el-table-column>
      ...
      <el-table-column label="进货日期" sortable="custom" prop="createTime">
      </el-table-column>
      ...
      <el-form :model="form" ref="ruleForm">
        ...
        <el-form-item label="进货信息" required :label-width="formLabelWidth" size="mini" style="margin-bottom:0px;">
          ...
          <el-form-item size="mini" style="display: inline-block;">
            <goods-dialog :button-type="2" ref="goodsDialog" @selectData="addGoods" placeholder-text="添加物品" selected-type=2 v-model="selectedGoods"></goods-dialog>
